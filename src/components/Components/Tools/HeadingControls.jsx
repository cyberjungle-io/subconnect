...
const HeadingControls = ({ style, onStyleChange }) => {
  ...
  useEffect(() => {
    if (style) {
      setHeadingText(style.content || '');
      setFontFamily(style.fontFamily || 'Arial, sans-serif');
      setFontSize(style.fontSize || '2rem');
      ...
      setHeadingLevel(style.headingLevel || 'h1');
